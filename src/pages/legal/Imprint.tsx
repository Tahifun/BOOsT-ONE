...
export default function Imprint() {
  return (
    <article style={{ maxWidth: 900, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <p>
        Wir sind gemäß §&nbsp;7 Abs.&nbsp;1 TMG für eigene Inhalte nach den allgemeinen Gesetzen verantwortlich.
      ...
      <p>
        ...
        Vervielfältigung, Bearbeitung und Verwertung außerhalb der Grenzen des Urheberrechts bedürfen unserer
        schriftlichen Zustimmung.
      </p>

      <p style={{ opacity: 0.7, marginTop: 24 }}>
        Dieses Impressum ist für Deutschland ausgelegt. – Aktualisiert am: 24.08.2025
      </p>
    </article>
  );
}
