...
/** ?????????????????????????????????????????????????????????
 *  Analytics Page
 *  - Enthlt drei Canvas-Visualisierungen:
    ...
    <div className="qa-root">
      ...
      <div className="qa-content">
        ...
        <div className="qa-grid qa-grid--top">
          ...
          <div className="qa-col">
            <EmotionalRadar />
            <ProFeatureWrapper featureName="analytics_deep" showUpgradePrompt message="Deep Analytics (Stimmung/Heatmaps/Trends) sind Teil von PRO. Hol dir Abo oder Tageskarte (24h) fr vollen Zugriff.">
