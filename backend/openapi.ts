// backend/openapi.ts
// OpenAPI 3.0 Spec als Plain-Object (keine Abhngigkeit zu swagger-jsdoc ntig)
...
export function buildOpenApiSpec(): AnyObj {
  const spec: AnyObj = {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "REST API fr Auth, Abos (PRO/DayPass), Checkout (EU-Consent), Billing-Portal und Overlays.",
      ...
      schemas: {
        ...
        CheckoutRequest: {
          ...
          example: {
            ...
            consent: true,
            consentText:
              "Ich stimme zu, dass der digitale Inhalt sofort verfgbar ist und ich mein Widerrufsrecht verliere.",
    ...
    paths: {
      ...
      "/api/subscription/webhook": {
        post: {
          ...
          description:
            "? Der Body **muss** unverndert (RAW) sein. Signatur-Verifikation via `STRIPE_WEBHOOK_SECRET`.",
          requestBody: {
            required: true,
            content: {
          ...
          responses: {
            ...
            "400": { description: "Signatur ungltig / Missing header" },
