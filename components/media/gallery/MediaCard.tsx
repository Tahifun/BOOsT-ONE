    ...
    >
      ...
      {showActions && (
        <div className="card-selection">
          <input
            ...
            aria-label={`${item.name} ausw�hlen`}
          />
        </div>
      )}
      ...
      {showActions && viewMode !== 'list' && (
        <div className="card-actions">
          ...
          <button className="action-btn danger" onClick={(e) => handleAction('delete', e)} aria-label="L�schen" title="L�schen">?</button>
        </div>
      )}
      ...
      {showContextMenu && (
        ...
        >
          ...
          <div className="context-menu-divider" />
          <button onClick={(e) => handleAction('delete', e)} className="danger"><span>?</span> L�schen</button>
        </div>
      )}
    </div>
  );
