...
// TODO: token künftig weglassen, wenn HttpOnly-Cookies aktiv sind
  ...
  return (
    <main style={{ maxWidth: 880, margin: "0 auto", padding: "24px 16px" }}>
      ...
      <p style={{ opacity: 0.85, marginBottom: 16 }}>
        Wähle dein Upgrade oder verwalte dein Abo. Der Checkout öffnet sich in einem neuen Fenster.
      </p>
