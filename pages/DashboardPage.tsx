    ...
    <div className={`epic-dashboard ${theme === "epic" ? "theme-epic" : ""}`}>
      ...
      <div className="dashboard-header">
        ...
        <div className="header-content">
          ...
          <Link to="/overlay/editor" className="overlay-editor-button">
            ...
            <span className="button-text"> OVERLAY EDITOR</span>
      ...
      <div className="dashboard-grid">
        ...
        <div className="grid-section additional-stats">
          ...
          <HolographicCard title="SPOTIFY" icon="" delay={0} className="spotify-card">
          ...
          <HolographicCard title="BOOST MOMENTS" icon="" delay={100}>
        ...
        <div className="grid-section primary-stats">
          ...
          <HolographicCard title="VIEWER ANALYTICS" icon="" delay={200}><ViewerStats /></HolographicCard>

          <HolographicCard title="FOLLOWER MATRIX" icon="" delay={300}><FollowerStats /></HolographicCard>

          <HolographicCard title="REVENUE STREAM" icon="" delay={400}><CoinStats /></HolographicCard>
        ...
        <div className="grid-section social-stats">
          ...
          <HolographicCard title="PRO ANALYTICS" icon="" delay={700} pro><ProAnalytics /></HolographicCard>
        ...
        <div className="grid-section advanced-stats">
          ...
          <HolographicCard title="VIEWER TIMELINE" icon="" delay={800}><ViewerGraph /></HolographicCard>
        ...
        <div className="grid-section engagement-stats">
          ...
          <HolographicCard title="HEAT SIGNATURE" icon="" delay={1100}><HeatmapStats /></HolographicCard>

          <HolographicCard title="REPLAY VALUE" icon="" delay={1200}><RewatchStats /></HolographicCard>

          <HolographicCard title="CHAT VELOCITY" icon="" delay={1300}><ChatPeakGraph /></HolographicCard>
