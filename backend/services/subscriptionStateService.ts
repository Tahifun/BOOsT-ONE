...
/** Liefert den Rohzustand; legt bei Bedarf FREE-Grundgerst an. */
...
export async function setProFromSubscription(userId: string, args: SetProArgs) {
  ...
  await SubscriptionStateModel.updateOne(
    { userId },
    {
      ...
      $unset: {
        // Day-Pass wird beim echten Abo zurckgesetzt
        "dayPass.active": "",
        "dayPass.validUntil": "",
        "dayPass.source": "",
        "dayPass.customerId": "",
...
/** Setzt User hart auf FREE (z. B. wenn Subscription gelscht). */
