    ...
    >
      ...
      {showActions && viewMode !== 'list' && (
        <div className="card-actions">
          ...
          <button className="action-btn" onClick={(e) => handleAction('edit', e)} aria-label="Bearbeiten" title="Bearbeiten">️</button>
          <button className="action-btn danger" onClick={(e) => handleAction('delete', e)} aria-label="Löschen" title="Löschen">️</button>
        </div>
      )}
      ...
      {showContextMenu && (
        ...
        >
          ...
          <button onClick={(e) => handleAction('edit', e)}><span>️</span> Bearbeiten</button>
          <button onClick={(e) => handleAction('rename', e)}><span></span> Umbenennen</button>
          <button onClick={(e) => handleAction('tags', e)}><span>️</span> Tags bearbeiten</button>
          <div className="context-menu-divider" />
          <button onClick={(e) => handleAction('delete', e)} className="danger"><span>️</span> Löschen</button>
        </div>
      )}
    </div>
  );
