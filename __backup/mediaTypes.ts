// Zentrale Typen & Konstanten für Medien

/** Frontend-weit erlaubte Medientypen */
export type MediaType = "clip" | "screenshot" | "sound" | "overlay";

/** Maximalgrößen je Typ (in MB) – UI- und Server-Validierung können sich darauf beziehen */
...
/** Accept-Strings je Typ (für <input type="file">, Drag&Drop-Hinweise etc.) */
...
/** Standard-API-Antwort für Upload */
...
/** (Optional) Filtermodell für Abfragen */
