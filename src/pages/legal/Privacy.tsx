...
export default function Privacy() {
  return (
    <article style={{ maxWidth: 900, margin: "0 auto", padding: "24px 16px" }}>
      <h1 style={{ fontSize: 24, marginBottom: 16 }}>Datenschutzerkl�rung</h1>

      <h3>Verantwortlicher</h3>
      <p>
        CLiP BOOsT - Rene Quilitzsch, Langestra�e 92, 19230 Hagenow, Deutschland<br />
      ...
      <ul>
        ...
        <li><strong>Zahlungsdaten:</strong> Abwicklung �ber Stripe; wir speichern keine Kartendaten</li>
      ...
      <ul>
        <li><strong>Vertrag/Erbringung</strong> (Art. 6 Abs. 1 lit. b): Konto, K�ufe, Bereitstellung der App.</li>
        <li>
          <strong>Consent-Audit-Log</strong> (Art. 6 Abs. 1 lit. f):
          Nachweis der Einwilligung/Verteidigung von Rechtsanspr�chen (berechtigtes Interesse).
        </li>
      ...
      <h3>Drittanbieter & �bermittlungen</h3>
      <ul>
      ...
      <p>Bei �bermittlungen in Drittl�nder kommen geeignete Garantien (z. B. Standardvertragsklauseln) zum Einsatz.</p>

      <h3>Speicherdauer</h3>
      <ul>
        <li>Account: bis zur L�schung</li>
        <li>Kauf-/Abrechnungsdaten: entsprechend gesetzlicher Fristen</li>
        <li>Consent-Logs: bis zum Ablauf einschl�giger Verj�hrungsfristen</li>
      </ul>

      <h3>Rechte der Betroffenen</h3>
      <ul>
        <li>Auskunft, Berichtigung, L�schung, Einschr�nkung, Daten�bertragbarkeit</li>
      ...
      <p style={{ opacity: 0.7, marginTop: 24 }}>
        Diese Erkl�rung dient der Transparenz und ersetzt keine Rechtsberatung. - Aktualisiert am: 24.08.2025
      </p>
    </article>
  );
}
