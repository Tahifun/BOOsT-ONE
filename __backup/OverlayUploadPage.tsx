// src/pages/QuantumOverlayUploadPage.tsx
...
const QuantumOverlayUploadPage: React.FC = () => {
  ...
  const handleFileSelect = (selectedFile: File) => {
    ...
    if (selectedFile.size > maxSize) {
      setError(`Datei zu groß! Maximum: ${TYPE_CONFIG[selectedType].maxMB}MB`);
      return;
    }
  ...
  return (
    {/* ⬇️ Wichtig: gültigen FeatureName verwenden */}
...
export default QuantumOverlayUploadPage;
